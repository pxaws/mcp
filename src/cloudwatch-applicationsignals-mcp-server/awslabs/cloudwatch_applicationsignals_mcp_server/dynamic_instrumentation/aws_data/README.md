# TEMPORARY — bundled private service model

> **Remove this entire `aws_data/` directory when the public AWS SDK ships the
> dynamic instrumentation operations.**

`application-signals/2024-04-15/service-2.json` is a temporary, bundled botocore
service model that exposes the dynamic-instrumentation operations
